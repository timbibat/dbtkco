        ...
        <div class="collapse w-100" id="${collapseId}">
          <div class="card card-body p-3 bg-light rounded mt-2">
            <div class="text-center">
              ...
              <button class="btn btn-dark mb-2 mx-auto py-2 add-to-cart" 
                      style="max-width: 200px;" 
                      data-product-id="${productId}" 
                      ${isOutOfStock ? 'disabled' : ''}>
                ${isOutOfStock ? 'Out of Stock' : 'Add to Cart'}
              </button>
              <!-- Add this inside your T-shirt card HTML, near the Add to Cart button -->
              <button class="btn btn-dark text-white mb-2 p-2" style="max-width: 200px" type="button" data-bs-toggle="collapse" data-bs-target="#sizeChart${index}" aria-expanded="false" aria-controls="sizeChart${index}">
                Size Chart
              </button>
              <div class="collapse size-chart mt-2" id="sizeChart${index}">
